...
const Expenses = () => {
  ...
  const [editId, setEditId] = useState(null); // null means add new, otherwise update
  ...
  return (
    <div className="p-6 text-white">
      ...
      {/* Grid container for Add Expense card + expense cards */}
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 max-w-5xl">
        ...
        {/* Expenses Cards */}
        {loading ? (
          <p className="text-slate-400 col-span-full">Loading expenses...</p>
        ) : expenses.length === 0 ? (
          ...
          expenses.map((exp) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between">
                <div className="text-sky-400 font-bold text-xl">${exp.amount.toFixed(2)}</div>
